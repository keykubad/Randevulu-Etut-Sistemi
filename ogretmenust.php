...
<head>
<meta charset="utf8">
    <title>Ekonomikhost Etüt Randevu Sistemi</title>
    ...
    <div class='navbar'>
        <div class='navbar-inner'>
            <div class='container-fluid'>
                <a class='brand' href='ogretmen.php'>
                    <i class='icon-user'></i>
                    <span class='hidden-phone'>Etüt Öğretmen Paneli</span>
                </a>
                ...
                <ul class='nav pull-right'>
                    ...
                    <li class='dropdown dark user-menu'>
                        <a class='dropdown-toggle' data-toggle='dropdown' href='#'>
                            ...
                            <span class='user-name hidden-phone'><?php echo $kim["adsoyad"];?></span>
                            <b class='caret'></b>
                        </a>
                        <ul class='dropdown-menu'>
                            <li class='divider'></li>
							<li>
                                <a href='ogretmen.php?sayfa=ogretmensifredegis'>
                                    <i class='icon-signout'></i>
                                   Şifre Değiştir
                                </a>
                            </li>
                            <li>
                                <a href='ogretmen.php?sayfa=cikis'>
                                    <i class='icon-signout'></i>
                                    Çıkış yap
                                </a>
                            </li>

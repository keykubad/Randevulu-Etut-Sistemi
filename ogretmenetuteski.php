    ...
    <div class='row-fluid'>
        <div class='span6 offset3'>
            <div class='text-center'>
                ...
                <small class='muted'>Bu bölümden kayıtlı geçiş etütlerinizi ve durumlarını görebilirsiniz..</small>
            </div>
        </div>
    </div>
</div>
...
<div class='box-header orange-background'>
    <div class='title'>Randevu listesi (Geçmiş)</div>
    <div class='actions'>
...
<tr>
   ...
   <td>
   <?php if($durum==1){echo "Yapıldı";}else{echo "Yapılmadı";}?>

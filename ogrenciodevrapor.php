...
<div class='row-fluid'>
 ...
 <div class='box-content'>
            <form class="form form-horizontal" method="post" style="margin-bottom: 0;" action="yonetici.php?sayfa=ogrenciodevraporuekran"/><div style="margin:0;padding:0;display:inline">

   ...
   <?php if($yap==1){echo "Yapıldı";}else{echo "Yapılmadı";}?>
    ...
    <td>
		...
		<?php 
			if($yap==0){
		?>
		 <a class='btn btn-success btn-medium' href='ogretmen.php?sayfa=ogretmenrandevuyap&id=<?php echo $rid;?>'>
                <i class='icon-ok'>Yapıldı</i>
            </a>
		<?php }else{ }?>
			  <a class='btn btn-success btn-medium' href='ogretmen.php?sayfa=ogretmenrandevukatilma&id=<?php echo $rid;?>&sinif=<?php echo $sinifc;?>'>
                Katılacakları Belirle
            </a>
            <a class='btn btn-danger btn-medium' href='ogretmen.php?sayfa=ogretmenrandevusil&id=<?php echo $rid;?>'>

    ...
    <div class='row-fluid'>
        <div class='span6 offset3'>
            <div class='text-center'>
                ...
                <small class='muted'>Bu bölümden sisteminize kayıtlı randevulara ait öğrenci listelerini yazdırabilirsiniz..</small>
            </div>
        </div>
    </div>
</div>
   ...
   <?php if($durum==1){echo "Etüt onaylı";}else{echo "Etüt henüz onaylanmamış";}?>
    ...
    <td>
        <div class='text-right'>
		   ...
		   ?>
                <center><a href="etutyazdir.php?tarih=<?php echo $tarih;?>&ogretmen=<?php echo $ogretmen;?>&saat=<?php echo $saat;?>" class="btn btn-primary btn-large">Yazdır</a></center>

            ...
            <form class="form form-horizontal" method="post" style="margin-bottom: 0;" /><div style="margin:0;padding:0;display:inline">
                ...
                <div class='controls'>
                    <div class='datetimepicker input-append' id='datetimepicker'>
                        <input class='input-medium' name="bas" data-format='dd-MM-yyyy' placeholder='Randevu tarihi seçiniz' type='text' />
            <span class='add-on'>
              <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
						...
						&nbsp;&nbsp;&nbsp;ile&nbsp;&nbsp;&nbsp;	 
                    <div class='datetimepicker input-append' id='datetimepicker'>
                        <input class='input-medium' name="son" data-format='dd-MM-yyyy' placeholder='Randevu tarihi seçiniz' type='text' />
            <span class='add-on'>
              <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
            </span>
               
                </div>&nbsp;&nbsp;&nbsp;tarihi arası öğretmen raporudur.
                </div>
...
$adi		=$_POST["adi"];
	if(($bas=="") || ($son=="") || ($adi=="")){
						...
						git("yonetici.php?sayfa=ogretmenrapor",5);
					}
?>

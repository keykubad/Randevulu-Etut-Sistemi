...
<head>
<meta charset="utf8">
    <title>Ekonomikhost Etüt Randevu Sistemi Yönetici Paneli</title>
        ...
        <div class='navbar-inner'>
            <div class='container-fluid'>
                <a class='brand' href='index.html'>
                    <i class='icon-user'></i>
                    <span class='hidden-phone'>Etüt Yönetici Paneli</span>
                </a>
                ...
                <ul class='nav pull-right'>
                    ...
                    <li class='dropdown dark user-menu'>
                        <a class='dropdown-toggle' data-toggle='dropdown' href='#'>
                            ...
                            <span class='user-name hidden-phone'><?php echo $_SESSION["kul"];?></span>
                            <b class='caret'></b>
                        </a>
                        <ul class='dropdown-menu'>
                            ...
                            <li class='divider'></li>
                            <li>
                                <a href='yonetici.php?sayfa=cikis'>

    ...
    <div class='row-fluid'>
        <div class='span6 offset3'>
            <div class='text-center'>
                ...
                <small class='muted'>Bu bölümden öğrencilerin kendi sayfalarına giriş yapabilirsiniz..</small>
            </div>
        </div>
    </div>
</div>
...
<div class='box-header orange-background'>
    <div class='title'>Öğrenci Kontrol</div>
    <div class='actions'>
...
<tr>
	...
	<td>
	 ...
	 <form method="post" action="index.php">
		 ...
		 <input class='btn btn-success btn-medium' type='submit' value="Giriş">
         </form>
